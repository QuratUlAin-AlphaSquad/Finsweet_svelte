...
<main class="content">
    ...
    <div>
        <p class="Andrew2">
            Andrew Jonson <span class="postedOn">
                Posted on 27th January 2021</span
            >
        </p>
    </div>
    <div class="contentImg">
        <img class="contentImg1"
            src="../images/people-working-in-front-of-computer-3182763.png"
            alt=""
        />
    </div>
    <div class="apparentlyDiv">
        <p class="apparentlyPara">
        ...
        <a class="readMore1" href="/">Read more</a>
    </div>
    <!-- Cards -->
    <div class="cards">
...
margin-right: 160px; */
    /* flex-shrink: 0; */
    /* background-image: url('https://www.pexels.com/photo/people-working-in-front-of-computer-3182763/'); */
    /* } */
    .apparentlyDiv {
        display: flex;
        max-width: 831px;
